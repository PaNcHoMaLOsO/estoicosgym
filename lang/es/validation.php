...
return [
    ...
    */
    ...
    'ascii' => 'El campo :attribute sólo puede contener caracteres alfanuméricos de un solo byte y símbolos.',
    ...
    'password' => [
        ...
        'uncompromised' => 'La :attribute ingresada ha aparecido en una filtración de datos. Por favor elige una :attribute diferente.',
    ],
    ...
    */
    ...
    'custom' => [
        'run_pasaporte' => [
            'unique' => 'Este RUT o pasaporte ya está registrado en el sistema.',
        ],
        'email' => [
        ...
        'fecha_nacimiento' => [
            ...
            'date' => 'Debe ingresar una fecha de nacimiento válida.',
        ],
        'celular' => [
            'regex' => 'El número de celular no tiene un formato válido.',
        ],
        'telefono_emergencia' => [
            'regex' => 'El teléfono de emergencia no tiene un formato válido.',
        ],
        'fecha_inicio' => [
            'after_or_equal' => 'La fecha de inicio debe ser hoy o una fecha futura.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'id_motivo_descuento' => 'motivo del descuento',
    ],
