...
class MembresiaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'max_pausas.required' => 'El máximo de pausas es obligatorio',
            'max_pausas.min' => 'El mínimo de pausas es 0',
            'max_pausas.max' => 'El máximo de pausas es 12',
        ...
        $membresia = Membresia::create([
            ...
            'max_pausas' => $validated['max_pausas'],
