...
<div class="page-container">
    ...
    <div class="container-fluid">
        <form action="{{ route('admin.pagos.store') }}" method="POST" id="formPago">
            ...
            <!-- SECCI├ôN 1: SELECCIONAR CLIENTE -->
            ...
            <!-- SECCI├ôN 2: INFORMACI├ôN DEL CLIENTE (Oculta inicialmente) -->
            <div class="form-section cliente-info-card hidden" id="clienteInfoSection">
                ...
                <div class="historial-section" id="historialSection">
                    <h5><i class="fas fa-history"></i> ├Ültimos Pagos</h5>
            ...
            <div class="form-section" id="datosPagoSection">
                ...
                <div class="pago-section active" id="seccion-abono">
                    ...
                    <div class="alert alert-info mt-3">
                        <strong>Resumen:</strong> Se abonar├ín $<span id="abono-monto">0</span> de los $<span id="abono-total">0</span> pendientes
                    </div>
                </div>
                ...
                <div class="pago-section" id="seccion-completo">
                    ...
                    <div class="alert alert-success mt-3">
                        <strong>Ô£ô El cliente quedar├í pagado completamente</strong>
                    </div>
                </div>
                ...
                <div class="pago-section" id="seccion-mixto">
                    ...
                    <div class="alert alert-warning mt-3">
                        ...
                        <span id="estado-mixto">ÔØî Monto incompleto</span>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('­ƒÜÇ Inicializando formulario de pagos v2...');
    ...
    $('#id_inscripcion').select2({
        width: '100%',
        language: 'es',
        placeholder: '­ƒöì Buscar cliente...',
        allowClear: true,
    ...
    function resetearCamposPago() {
        ...
        document.getElementById('estado-mixto').innerHTML = 'ÔØî Incompleto';
    }
    ...
    function validarFormulario() {
        ...
        if (tipoPago === 'abono') {
            ...
            if (total === pendiente) {
                document.getElementById('estado-mixto').innerHTML = 'Ô£ô Correcto';
                document.getElementById('estado-mixto').style.color = '#28a745';
            } else if (total > pendiente) {
                document.getElementById('estado-mixto').innerHTML = 'ÔØî Excede';
    ...
    console.log('Ô£ô Formulario inicializado correctamente');
});
</script>
@endsection
