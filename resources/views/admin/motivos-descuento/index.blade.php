                    ...
                    <tbody>
                        @foreach($motivos as $motivo)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.motivos-descuento.show', $motivo) }}" class="btn btn-sm btn-info">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.motivos-descuento.edit', $motivo) }}" class="btn btn-sm btn-warning">
