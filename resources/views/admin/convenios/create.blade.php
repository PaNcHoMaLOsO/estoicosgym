...
<style>
    ...
    .page-header small { color: rgba(255,255,255,0.7); }
    ...
    .btn-header:hover { background: rgba(255,255,255,0.25); color: white; }
    ...
    .btn-submit:hover { background: #00a67d; color: white; transform: translateY(-2px); }
...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1><i class="fas fa-plus-circle"></i> Crear Nuevo Convenio</h1>
                <small>Registra un nuevo convenio institucional o empresarial</small>
            </div>
            <div class="col-md-4 text-right">
                <a href="{{ route('admin.convenios.index') }}" class="btn btn-header">
    ...
    <form action="{{ route('admin.convenios.store') }}" method="POST">
        @csrf
        <input type="hidden" name="form_token" value="{{ 'convenio_create_' . uniqid() }}">
        ...
        <div class="form-card">
                ...
                <div class="row mb-4">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control form-control-modern @error('nombre') is-invalid @enderror" 
                               name="nombre" value="{{ old('nombre') }}" placeholder="Ej: INACAP, Cruz Verde" required>
                ...
                <div class="row mb-4">
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control form-control-modern @error('descripcion') is-invalid @enderror" 
                                  name="descripcion" rows="3" placeholder="Detalles y términos del convenio...">{{ old('descripcion') }}</textarea>
                ...
                <div class="row mb-4">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control form-control-modern @error('contacto_nombre') is-invalid @enderror" 
                               name="contacto_nombre" value="{{ old('contacto_nombre') }}" placeholder="Nombre completo">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control form-control-modern @error('contacto_telefono') is-invalid @enderror" 
                               name="contacto_telefono" value="{{ old('contacto_telefono') }}" placeholder="+56 9 1234 5678">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="email" class="form-control form-control-modern @error('contacto_email') is-invalid @enderror" 
                               name="contacto_email" value="{{ old('contacto_email') }}" placeholder="contacto@ejemplo.com">
            ...
            <div class="form-footer">
                <a href="{{ route('admin.convenios.index') }}" class="btn btn-cancel">
                    <i class="fas fa-times"></i> Cancelar
                </a>
                <button type="submit" class="btn btn-submit">
                    <i class="fas fa-save"></i> Crear Convenio
                </button>
            </div>
        </div>
    </form>
