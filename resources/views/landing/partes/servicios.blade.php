<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    @foreach($servicios as $index => $servicio)
        ...
        <div class="animate-on-scroll card-hover bg-pg-carbon/70 border border-pg-tiza/10 rounded-2xl p-6 hover:border-pg-rojo/40" style="animation-delay: {{ $index * 0.1 }}s">
