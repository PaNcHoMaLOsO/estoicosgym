...
<section class="pt-28 pb-12 bg-pg-negro">
    ...
    <div class="max-w-[1520px] mx-auto px-4 sm:px-6 lg:px-8 text-center fade-in">
        ...
        <h1 class="font-display text-4xl md:text-5xl text-pg-tiza mt-3 uppercase">{{ $titulo }}</h1>
        @if(!empty($bajada))
            <p class="text-pg-tiza/65 mt-5 max-w-3xl mx-auto font-modern text-base">{{ $bajada }}</p>
        @endif
    </div>
</section>
