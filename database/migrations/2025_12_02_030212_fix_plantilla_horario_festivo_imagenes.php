...
return new class extends Migration
{
    /**
     * Run the migrations.
     * Corrige la plantilla de horario festivo - sin dependencia de imágenes externas
     */
...
<body style="font-family: \'Segoe UI\', Arial, sans-serif; background: #f4f4f4; margin: 0; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
        ...
        <!-- Header con logo textual sobre fondo oscuro -->
        <div style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); padding: 35px 30px; text-align: center;">
            <div style="display: inline-block; padding: 15px 25px; border: 2px solid #e94560; border-radius: 10px;">
                <span style="color: #ffffff; font-size: 28px; font-weight: 800; letter-spacing: 2px;">ESTOICOS</span>
                <span style="color: #e94560; font-size: 28px; font-weight: 800; letter-spacing: 2px;">GYM</span>
            </div>
        </div>
        ...
        <div style="background: #1a1a2e; padding: 25px; text-align: center;">
            <div style="margin-bottom: 15px;">
                <span style="color: #ffffff; font-size: 18px; font-weight: 700;">ESTOICOS</span>
                <span style="color: #e94560; font-size: 18px; font-weight: 700;">GYM</span>
            </div>
