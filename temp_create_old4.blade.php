...
@section('content')
    ...
    <form action="{{ route('admin.pagos.store') }}" method="POST" id="formPago">
                    ...
                    <select class="form-control select2 @error('id_inscripcion') is-invalid @enderror" 
                        ...
                        @foreach($inscripciones as $insc)
                            ...
                            <option value="{{ $insc->id }}" 
                                ...
                                ­ƒôï {{ $insc->cliente->nombres }} {{ $insc->cliente->apellido_paterno }} - {{ $insc->membresia->nombre }}
                            </option>
                        @endforeach
                    </select>
        ...
        <!-- 2. INFORMACI├ôN DEL CLIENTE (din├ímica) -->
                ...
                <div id="seccion-completo" class="pago-section d-none">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>
                                    <i class="fas fa-money-bill-wave"></i> Monto a Pagar (Autom├ítico)
                                </label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">$</span>
                    ...
                    <div class="resumen-pago">
                        Ô£ô Estado: <strong>PAGADO COMPLETAMENTE</strong>
                    </div>
                </div>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <small class="text-muted">Se registra autom├íticamente hoy si no cambias</small>
                        </div>
                    </div>
                </div>
